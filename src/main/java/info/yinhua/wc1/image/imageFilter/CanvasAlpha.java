package info.yinhua.wc1.image.imageFilter;
...
// merge transparency and canvas
public class CanvasAlpha implements ImageFilter {
	/**
	 ...
	 */
	public CanvasAlpha(int width, int height, Position position)
	{
	 ...
	 */
	public CanvasAlpha(int width, int height, Position position, boolean crop)
	{
	 ...
	 */
	public CanvasAlpha(int width, int height, Position position, Color fillColor)
	{
	 ...
	 * 						the specified color as well.
	 */
	public CanvasAlpha(int width, int height, Position position, boolean crop, Color fillColor)
	{
		super();
		this.width = width;
		this.height = height;
	...
	public BufferedImage apply(BufferedImage img) {
		 ...
		 * the enclosed image exceeds the dimension of the enclosing image, then
		 * the enclosing image will have its dimension enlarged.
		 * 
		 */
		...
		this.composite = AlphaComposite.getInstance(AlphaComposite.SRC_OVER, 0);
...
//		this.composite = AlphaComposite.getInstance(AlphaComposite.SRC_OVER, 0.2f);
//		g.setComposite(composite);
